...
function agregarMetodoPrototype(Usuario) {
  ...
  /* Usuario.prototype.saludar = function(){
   ...
   Usuario.prototype.saludar = () => "Hello World!";  // El prototype sirve para agregarle a la clase  
                                                      // un metodo o funcion ; 
}
...
function agregarStringInvertida() {
   ...
   // [PISTA]: necesitarás utilizar el objeto "this".
    ...
    /*El método reverse() en JavaScript sirve para invertir el orden de los elementos en un array */
    let stringReverse = [];
